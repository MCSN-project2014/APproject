...
\newpage
\includegraphics[height=19cm][caption=Order of the children of some labeled \texttt{Node}'s; curly braces indicates one or n copies of a certain node, round braces one among a few options. {nodesAST/Program}
